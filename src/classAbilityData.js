playerMoves = {
    ...
    'psionicEnergyStorm': {
        class: 'esper', prestige: 1, type: 0, sub: 0, position: { row: 8, column: 5 },
        category: 'melee',
        name: "Psionic Energy Storm",
        description: "Use a huge amount of psionic energy to create a storm that attacks and mind in the area.",
        iconName: "placeholder",
        damage: 1,
        damageRatios: [0, 0, 1, 0],
        damageRange: [1, 3],
        effects: {
            'aoe': 100,
            'repeat':10,
    ...
    'seriousMode': {
        class: 'superhuman', prestige: 1, type: 3, sub: 0, position: { row: 7, column: 5 },
    ...
    'earthShake': {
        class: 'superhuman', prestige: 1, type: 0, sub: 1, position: { row: 9, column: 4 },prestige: 1,
        category: 'melee',
        name: "Earth Shake",
        description: "",
        iconName: "groundStomp",
    ...
    'dragonPunch': {
        class: 'superhuman', prestige: 1, type: 0, sub: 2, position: { row: 7, column: 5 },
        category: 'melee', name: "Dragon Punch",
        description: "", iconName: "placeHolder",
        damageRatios: [2, 0, 1.5, 0.5],
        damageRange: [1, 1.2],
        effects: {
            'aoe': 30,
        },
        time: 3000, cooldownTime: 10000, range: [5, 5], cost: 0,
    },
    'kiBeam': {
        class: 'superhuman', prestige: 1, type: 0, sub: 2, position: { row: 8, column: 5 },
        category: 'melee', name: "Ki Beam",
        description: "", iconName: "placeHolder",
        damageRatios: [2, 0, 1.5, 0.5],
        damageRange: [1, 1.2],
        effects: {
        ...
        time: 3000, cooldownTime: 30000, range: [30,30], cost: 0,
    },
    //NINJA
    //BLADELORE
    'katana': {
    ...
    'windSlash2': {
        ...
        category: 'ranged',
        name: "Arc Slash",
        description: "Refining your Wind Slash technique to be more concentrated <br> you launch out multiple energized slices",
        iconName: "windSlash",
        damage: 0,
        damageRatios: [.7, 0, 0, .8],
        damageRange: [1, 1.3],
        effects: {
            criticalChance: 0.3,
            repeat: 1.5,
